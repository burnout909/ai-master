...
export const PAPERS_META: PaperMeta[] = [
  ...
  // ——— Alignment ———
  { slug: "instructgpt", title: "Training Language Models to Follow Instructions", authors: "Ouyang et al.", year: 2022, era: "alignment", arxivId: "2203.02155", summary: "RLHF pipeline behind ChatGPT.", status: "implemented", influencedBy: ["gpt3"] },
  ...
  { slug: "dpo",         title: "Direct Preference Optimization", authors: "Rafailov et al.", year: 2023, era: "alignment", arxivId: "2305.18290", summary: "Preference learning without a reward model.", status: "implemented", influencedBy: ["instructgpt"] },
  ...
  { slug: "toolformer",  title: "Toolformer: Language Models Can Teach Themselves to Use Tools", authors: "Schick et al.", year: 2023, era: "agents", arxivId: "2302.04761", summary: "Self-supervised tool-use training.", status: "implemented", influencedBy: ["react"] },
  { slug: "reflexion",   title: "Reflexion: Language Agents with Verbal Reinforcement Learning", authors: "Shinn et al.", year: 2023, era: "agents", arxivId: "2303.11366", summary: "Self-reflection improves agent performance.", status: "implemented", influencedBy: ["react"] },
  { slug: "tot",         title: "Tree of Thoughts: Deliberate Problem Solving with LLMs", authors: "Yao et al.", year: 2023, era: "agents", arxivId: "2305.10601", summary: "Tree-search over reasoning steps.", status: "implemented", influencedBy: ["cot"] },
  { slug: "voyager",     title: "Voyager: An Open-Ended Embodied Agent with LLMs", authors: "Wang et al.", year: 2023, era: "agents", arxivId: "2305.16291", summary: "LLM skill library with code-as-actions.", status: "implemented", influencedBy: ["react"] },
  { slug: "deepseek-r1", title: "DeepSeek-R1: Incentivizing Reasoning via Pure RL", authors: "DeepSeek-AI", year: 2025, era: "agents", arxivId: "2501.12948", summary: "RL-only reasoning training at scale.", status: "implemented", influencedBy: ["cot"] },
];
